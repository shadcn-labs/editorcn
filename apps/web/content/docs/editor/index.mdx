...
| --------------- | ------------------------- | ------------------------------------ | -------------------------------------------------------------------------- |
| `editor`        | `Editor \| null`          | —                                    | The Tiptap editor instance                                                 |
| `items`         | `FloatingMenuItem[]`      | `defaultFloatingMenuItems`           | Menu buttons; each has `icon`, `label`, `command`, and optional `isActive` |
...
You can also configure the predicate once on the extension instead of the component:
